# ABW Python FOSS — Publication Dry-Run Review
...
|----------------------|------------------------------------------|
| format_id            | abw                                      |
| package_name         | aspose-format-factory-abw                |
| module_import        | abw                                      |
| version              | 0.1.0.dev0                               |
...
| Gate | Status          | Notes                                                        |
|------|-----------------|--------------------------------------------------------------|
| 1    | passed          | Format authorized — GPL AbiWord XML format                   |
| 2    | passed          | Spec acquired — AbiWord XML format specification             |
| 3    | passed          | Sample corpus (3 samples)                                    |
| 4    | passed          | Parser prototype                                             |
| 5    | passed          | Oracle plan defined                                          |
| 6    | passed_planning | Oracle plan: AbiWord application comparison                  |
...
- [x] Source code present: src/python/abw/
- [x] Unit tests passing: tests/python/abw/
- [x] Examples present: examples/python/abw/
