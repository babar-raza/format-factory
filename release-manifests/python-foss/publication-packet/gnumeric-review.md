# Gnumeric Python FOSS — Publication Dry-Run Review
...
|----------------------|------------------------------------------|
| format_id            | gnumeric                                 |
| package_name         | aspose-format-factory-gnumeric           |
| module_import        | gnumeric                                 |
| version              | 0.1.0.dev0                               |
...
| Gate | Status          | Notes                                                    |
|------|-----------------|----------------------------------------------------------|
| 1    | passed          | Format authorized — LGPL Gnumeric application XML format |
| 2    | passed          | Spec acquired — Gnumeric XML format specification        |
| 3    | passed          | Sample corpus (3 samples)                                |
| 4    | passed          | Parser prototype                                         |
| 5    | passed          | Oracle plan defined                                      |
| 6    | passed_planning | Oracle plan: Gnumeric application comparison             |
| 7    | passed          | XXE-safe (xml.etree.ElementTree), file size guard        |
...
- [x] Source code present: src/python/gnumeric/
- [x] Unit tests passing: tests/python/gnumeric/
- [x] Examples present: examples/python/gnumeric/
