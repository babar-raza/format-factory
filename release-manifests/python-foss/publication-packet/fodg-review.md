# FODG Python FOSS — Publication Dry-Run Review
...
|----------------------|------------------------------------------|
| format_id            | fodg                                     |
| package_name         | aspose-format-factory-fodg               |
| module_import        | fodg                                     |
| version              | 0.1.0.dev0                               |
...
| 6    | passed_planning  | Oracle plan: LibreOffice Draw comparison           |
...
- [x] Source code present: src/python/fodg/
- [x] Unit tests passing: tests/python/fodg/
- [x] Examples present: examples/python/fodg/
