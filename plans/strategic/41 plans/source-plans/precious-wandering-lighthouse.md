...
|---|---|---|---|---|
| TC-001 | P0 | — | Verify and fix CERT-DASHBOARD-001 | TODO |
| TC-002 | P0 | — | Build run_manager.py (atomic run concept) | TODO |
| TC-003 | P0 | TC-002 | MISSING_EVIDENCE verdict semantics | TODO |
| TC-004 | P0 | TC-003 | Known-bad fixtures + behavioral tests | TODO |
| TC-005 | P1 | — | Automated gap reconciler | TODO |
| TC-006 | P1 | — | L28 skill registration + maturity 4/5 | TODO |
| TC-007 | P1 | TC-002, TC-006 | 5 governance validators | TODO |
| TC-008 | P1 | TC-006, TC-007 | Fix continuation signal + wiring | TODO |
| TC-009 | P1 | TC-001, TC-002, TC-003 | Pilot report regeneration | TODO |
| TC-010 | P1 | all | Final validation + terminal closure | TODO |
