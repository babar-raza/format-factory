...
|---|---|---|
| TC-SMR-001 | Commit accumulated supervisor state + evaluate .runner_system_id | OPEN |
| TC-SMR-002 | Execute REWORK-PQ-019-020-CLI-STUBS (CLI entry points + type stubs, 20 packages) | OPEN |
| TC-SMR-003 | Implement Fix-RC-001: Capability-compiler quality gate for "unknown" features | OPEN |
| TC-SMR-004 | Implement Fix-RC-004: Single source of truth for validator expected_count | OPEN |
| TC-SMR-005 | Persist remaining fixes as governed taskcards (RC-002, RC-003, RC-005, RC-006) | OPEN |
| TC-SMR-006 | Sprint closeout: evidence declaration + autonomous-cycle + review package | OPEN |
