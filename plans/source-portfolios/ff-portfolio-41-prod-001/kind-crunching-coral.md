...
### TC-BOOL-001: Implement `close_implementation_verified_gaps()` | Status: OPEN
...
### TC-BOOL-002: Wire into `autonomous_cycle.py` | Status: OPEN
...
### TC-BOOL-003: Fix `_SKIP_STATUSES` in compiler and consumer | Status: OPEN
...
### TC-BOOL-004: Add V-NEW governance validator | Status: OPEN
...
### TC-BOOL-005: Run integration dry-run + apply + sprint closeout | Status: OPEN
