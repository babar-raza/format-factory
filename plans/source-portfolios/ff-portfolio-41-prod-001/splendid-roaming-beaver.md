...
|---|---|---|---|---|
| TC-SRB-RW1 | Resolve PQ-029-ADDRECORD | PARENT | CLOSED | — |
| TC-SRB-RW1-01 | Verify AddRecord in NdjsonDocument.cs | CHILD | CLOSED | TC-SRB-RW1 |
| TC-SRB-RW1-02 | Implement AddRecord if missing | CHILD | CLOSED | TC-SRB-RW1 |
| TC-SRB-RW1-03 | Write test and declare evidence | CHILD | CLOSED | TC-SRB-RW1 |
| TC-SRB-RW2 | Resolve PQ-019-020-CLI-STUBS | PARENT | DEFERRED_WITH_REASON | — |
| TC-SRB-RW2-01 | Audit 18 missing packages | CHILD | DEFERRED_WITH_REASON | TC-SRB-RW2 |
| TC-SRB-RW2-02 | Implement CLI entry points for 18 packages | CHILD | DEFERRED_WITH_REASON | TC-SRB-RW2 |
| TC-SRB-RW2-03 | Implement type stubs for 18 packages | CHILD | DEFERRED_WITH_REASON | TC-SRB-RW2 |
| TC-SRB-RW2-04 | Test and declare evidence | CHILD | DEFERRED_WITH_REASON | TC-SRB-RW2 |
| TC-SRB-000 | Copy plan and write plan lock | PARENT | CLOSED | — |
| TC-SRB-000-01 | Copy plan file to repo | CHILD | CLOSED | TC-SRB-000 |
| TC-SRB-000-02 | Write plan lock | CHILD | CLOSED | TC-SRB-000 |
| TC-SRB-001 | Run check_continuation baseline | PARENT | CLOSED | — |
| TC-SRB-001-01 | Run check_continuation.py | CHILD | CLOSED | TC-SRB-001 |
| TC-SRB-001-02 | Fix any STOP condition | CHILD | CLOSED | TC-SRB-001 |
| TC-SRB-002 | Capture state baseline | PARENT | CLOSED | — |
| TC-SRB-010 | Build sprint inventory | PARENT | CLOSED | — |
| TC-SRB-010-01 | Enumerate plan-locks | CHILD | CLOSED | TC-SRB-010 |
| TC-SRB-010-02 | Enumerate evidence bundles | CHILD | CLOSED | TC-SRB-010 |
| TC-SRB-010-03 | Write sprint-inventory.json | CHILD | CLOSED | TC-SRB-010 |
| TC-SRB-011 | Detect sprint anomalies | PARENT | CLOSED | — |
| TC-SRB-012 | Fix stale/orphan locks | PARENT | CLOSED | — |
| TC-SRB-013 | Establish sprint identity contract | PARENT | CLOSED | — |
| TC-SRB-020 | Implement sprint_number_allocator.py | PARENT | CLOSED | — |
| TC-SRB-020-01 | Create ledger schema + empty ledger | CHILD | CLOSED | TC-SRB-020 |
| TC-SRB-020-02 | Implement load_ledger + find_highest | CHILD | CLOSED | TC-SRB-020 |
| TC-SRB-020-03 | Implement allocate subcommand | CHILD | CLOSED | TC-SRB-020 |
| TC-SRB-020-04 | Implement recover subcommand | CHILD | CLOSED | TC-SRB-020 |
| TC-SRB-020-05 | Implement status + list subcommands | CHILD | CLOSED | TC-SRB-020 |
| TC-SRB-021 | Register allocator as skill | PARENT | CLOSED | — |
| TC-SRB-022 | Test allocator idempotency | PARENT | CLOSED | — |
| TC-SRB-022-01 | Test same alias → same number | CHILD | CLOSED | TC-SRB-022 |
| TC-SRB-022-02 | Test different alias → next number | CHILD | CLOSED | TC-SRB-022 |
| TC-SRB-022-03 | Verify ledger entry count | CHILD | CLOSED | TC-SRB-022 |
| TC-SRB-022-04 | Verify no stale lock file remains | CHILD | CLOSED | TC-SRB-022 |
| TC-SRB-023 | Concurrent allocation safety pilot | PARENT | CLOSED | — |
| TC-SRB-024 | Interrupted allocation recovery | PARENT | CLOSED | — |
| TC-SRB-030 | Reproduce AUTONOMOUS_CONTINUE:NO | PARENT | DEFERRED_WITH_REASON | — |
| TC-SRB-031 | Add continuation_reason_codes field | PARENT | CLOSED | — |
| TC-SRB-031-01 | Read autonomous_cycle.py signal writer | CHILD | CLOSED | TC-SRB-031 |
| TC-SRB-031-02 | Add continuation_reason_codes field | CHILD | CLOSED | TC-SRB-031 |
| TC-SRB-031-03 | Test field appears after autonomous-cycle | CHILD | CLOSED | TC-SRB-031 |
| TC-SRB-032 | Governance recovery pilot | PARENT | DEFERRED_WITH_REASON | — |
| TC-SRB-040 | Add production section to master-plan.md | PARENT | DEFERRED_WITH_REASON | — |
| TC-SRB-P01 | Pilot 1: Sprint monotonicity | PARENT | CLOSED | — |
| TC-SRB-P02 | Pilot 2: Concurrent allocation | PARENT | CLOSED | — |
| TC-SRB-P03 | Pilot 3: Interrupted recovery | PARENT | CLOSED | — |
| TC-SRB-P04 | Pilot 4: Governance repair | PARENT | DEFERRED_WITH_REASON | — |
| TC-SRB-P05 | Pilot 5: Missing skill handling | PARENT | DEFERRED_WITH_REASON | — |
| TC-SRB-P06 | Pilot 6: Product deepening | PARENT | DEFERRED_WITH_REASON | — |
| TC-SRB-P07 | Pilot 7: Shared machinery regression | PARENT | DEFERRED_WITH_REASON | — |
| TC-SRB-P08 | Pilot 8: 3 consecutive autonomous sprints | PARENT | DEFERRED_WITH_REASON | — |
| TC-SRB-P09 | Pilot 9: Gate 11 simulated stop | PARENT | DEFERRED_WITH_REASON | — |
| TC-SRB-P10 | Pilot 10: No-change idempotency | PARENT | DEFERRED_WITH_REASON | — |
| TC-SRB-070 | Product deepening sprint 1 | PARENT | DEFERRED_WITH_REASON | — |
| TC-SRB-071 | Product deepening sprint 2 | PARENT | DEFERRED_WITH_REASON | — |
| TC-SRB-090 | Production readiness audit | PARENT | DEFERRED_WITH_REASON | — |
...
<!--plan_terminal_lock:
  ...
  locked_at: "2026-07-12T14:13:42.362800+00:00"
