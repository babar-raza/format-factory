...
> **Current authority overlay: Event 39.** Preserve the durable state-machine
...
Current native head: `FF6-EVENT-000039`; exact route:
`XLF-04-BATCH-005-PARTIAL-002-H`; accepted boundary: 30/105 obligations and
8/1,130 dispositions. The disjoint UBL checkpoint contains 6,001 local
