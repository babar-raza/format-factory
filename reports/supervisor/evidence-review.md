...
Sprint ID: unknown
Timestamp: 2026-06-02T19:21:04.298418
Verdict: BLOCKED_MISSING_FINAL_VERDICT
Bundle: C:\Users\prora\OneDrive\Documents\GitHub\format-factory\.local\supervisor\reviews\r93\declaration-review-package.zip
...
Bundle: c:\Users\prora\OneDrive\Documents\GitHub\format-factory\.local\supervisor\reviews\r93\declaration-review-package.zip
Bundle size: 22,254 bytes
Total entries: 13
Top-level folders: ['evidence', 'package-manifest.json', 'r91-review', 'state', 'supervisor']
Repo files: 0
Metadata files: 0
...
WARNINGS:
  - Extra top-level folders (not in required list): ['evidence', 'package-manifest.json', 'r91-review', 'state', 'supervisor']
...
ERRORS:
  ...
  - RUN_CONTRACT_METADATA_FLOOR: FAIL — metadata cou
```
