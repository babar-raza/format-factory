...
**Goal:** Advance Skills tooling: Expand governed skill commands; Strengthen transcript validation. Build evidence declaration and run supervisor autonomous-cycle.
...
| B | G2 | Expand governed skill commands |
| C | G2 | Strengthen transcript validation |
...
### Train B: Expand governed skill commands

Add new governed skills or improve skill validation.
...
### Train C: Strengthen transcript validation

Improve transcript ledger, validation fixtures, or governance checks.
