---
artifact_id: fodt-commercial-package-dry-run-20260513
...
# FODT Commercial Package Dry-Run

## Package Metadata

| Field | Value |
|-------|-------|
| PackageId | FormatFactory.Fodt |
| Version | 0.1.0-tier0 |
| Authors | format-factory |
| Description | .NET commercial parser for FODT |
...
| Package file | FormatFactory.Fodt.0.1.0-tier0.nupkg (7,386 bytes) |
