"""
tsv_to_ppm.py — Dogfood export: TSV → PPM using Format Factory libraries.

Sprint: TSV-TO-PPM-DOGFOOD-001
Authority: TASK-007 -- Advance one dogfood export path
Ledger entry: R90-TSV-TO-PPM-DOGFOOD-001
License: Apache-2.0
"""
...
def tsv_to_ppm(
    ...
    *,
    ...
    """Convert a TSV file to a PPM bitmap, one RGB-row per data row."""
