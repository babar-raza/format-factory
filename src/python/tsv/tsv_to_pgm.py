"""
tsv_to_pgm.py — Dogfood export: TSV → PGM using Format Factory libraries.

Sprint: TSV-TO-PGM-DOGFOOD-001
Authority: TASK-007 -- Advance one dogfood export path
Ledger entry: R90-TSV-TO-PGM-DOGFOOD-001
License: Apache-2.0
"""
...
def tsv_to_pgm(
    ...
    *,
    ...
    """Convert a TSV file to a PGM bitmap, one grayscale-row per data row."""
