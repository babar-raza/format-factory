"""
abw_to_ppm.py — Dogfood export: ABW → PPM using Format Factory libraries.

Sprint: ABW-TO-PPM-DOGFOOD-001
Authority: TASK-007 -- Advance one dogfood export path
Ledger entry: R90-ABW-TO-PPM-DOGFOOD-001
License: Apache-2.0
"""
...
def abw_to_ppm(
    ...
    """Convert a ABW file to a PPM bitmap, one RGB-row per data row."""
