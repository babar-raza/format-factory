"""
ndjson_to_pgm.py — Dogfood export: NDJSON → PGM using Format Factory libraries.

Sprint: NDJSON-TO-PGM-DOGFOOD-001
Authority: TASK-007 -- Advance one dogfood export path
Ledger entry: R90-NDJSON-TO-PGM-DOGFOOD-001
License: Apache-2.0
"""
...
def ndjson_to_pgm(
    ...
    """Convert a NDJSON file to a PGM bitmap, one grayscale-row per data row."""
