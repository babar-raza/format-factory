"""
ods_to_ppm.py — Dogfood export: ODS → PPM using Format Factory libraries.

Sprint: ODS-TO-PPM-DOGFOOD-001
Authority: TASK-007 -- Advance one dogfood export path
Ledger entry: R90-ODS-TO-PPM-DOGFOOD-001
License: Apache-2.0
"""
...
def ods_to_ppm(
    ...
    *,
    ...
    """Convert a ODS file to a PPM bitmap, one RGB-row per data row."""
