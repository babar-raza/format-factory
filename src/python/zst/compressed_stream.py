...
def zst_size_exceeds_50(path: "str | Path") -> bool:
    ...
    Spec: RFC 8878 §3.1 — Zstandard frame header compressed size (SAL-ZST-00001).
    """
...
def zst_frame_count_exceeds_one(path: "str | Path") -> bool:
    ...
    Spec: RFC 8878 §3.1 — a Zstandard-compressed content may contain multiple frames (SAL-ZST-00001).
    """
...
def zst_max_byte_value(path: "str | Path") -> int:
    ...
    Spec: RFC 8878 §3.1 — decompressed content of a Zstandard frame (SAL-ZST-00001).
    """
    try:
...
def zst_min_byte_exceeds_zero(path: "str | Path") -> bool:
    ...
    Spec: RFC 8878 §3.1 — decompressed content byte range (SAL-ZST-00001).
    """
...
def zst_is_empty_decompressed(path: "str | Path") -> bool:
    ...
    Spec: RFC 8878 §3.1 — empty decompressed content is valid (SAL-ZST-00001).
    """
...
def zst_is_trivial_compression(path: "str | Path") -> bool:
    ...
    Spec: RFC 8878 §3.1 — compression ratio derived from frame sizes (SAL-ZST-00001).
    """
...
def zst_byte_range(file_path: "str | Path") -> int:
    ...
    Spec: RFC 8878 §3.1 — decompressed content byte distribution (SAL-ZST-00001).
    """
...
def zst_is_single_byte(file_path: "str | Path") -> bool:
    ...
    Spec: RFC 8878 §3.1 — decompressed content uniformity predicate (SAL-ZST-00001).
    """
