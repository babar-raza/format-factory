...
QN_DOCUMENT:    str = f"{{{NS_OFFICE}}}document"  # SAL-FODS-00001: root element is office:document
...
ATTR_MIMETYPE:      str = f"{{{NS_OFFICE}}}mimetype"  # SAL-FODS-00001: mimetype attribute identifies ODS flat-xml
