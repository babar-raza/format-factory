"""
fods_to_pbm.py — Dogfood export: FODS → PBM using Format Factory libraries.

Sprint: FODS-TO-PBM-DOGFOOD-001
Authority: TASK-007 -- Advance one dogfood export path
Ledger entry: R90-FODS-TO-PBM-DOGFOOD-001
License: Apache-2.0
"""
...
def fods_to_pbm(
    ...
    *,
    ...
    """Convert a FODS file to a PBM bitmap, one pixel-row per data row."""
