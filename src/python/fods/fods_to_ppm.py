"""
fods_to_ppm.py — Dogfood export: FODS → PPM using Format Factory libraries.

Sprint: FODS-TO-PPM-DOGFOOD-001
Authority: TASK-007 -- Advance one dogfood export path
Ledger entry: R90-FODS-TO-PPM-DOGFOOD-001
License: Apache-2.0
"""
...
def fods_to_ppm(
    ...
    *,
    ...
    """Convert a FODS file to a PPM bitmap, one RGB-row per data row."""
