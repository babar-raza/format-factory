"""
gnumeric_to_ppm.py — Dogfood export: GNUMERIC → PPM using Format Factory libraries.

Sprint: GNUMERIC-TO-PPM-DOGFOOD-001
Authority: TASK-007 -- Advance one dogfood export path
Ledger entry: R90-GNUMERIC-TO-PPM-DOGFOOD-001
License: Apache-2.0
"""
...
def gnumeric_to_ppm(
    ...
    *,
    ...
    """Convert a GNUMERIC file to a PPM bitmap, one RGB-row per data row."""
