"""
gnumeric_to_pbm.py — Dogfood export: GNUMERIC → PBM using Format Factory libraries.

Sprint: GNUMERIC-TO-PBM-DOGFOOD-001
Authority: TASK-007 -- Advance one dogfood export path
Ledger entry: R90-GNUMERIC-TO-PBM-DOGFOOD-001
License: Apache-2.0
"""
...
def gnumeric_to_pbm(
    ...
    *,
    ...
    """Convert a GNUMERIC file to a PBM bitmap, one pixel-row per data row."""
