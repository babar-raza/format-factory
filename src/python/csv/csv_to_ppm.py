"""
csv_to_ppm.py — Dogfood export: CSV → PPM using Format Factory libraries.

Sprint: CSV-TO-PPM-DOGFOOD-001
Authority: TASK-007 -- Advance one dogfood export path
Ledger entry: R90-CSV-TO-PPM-DOGFOOD-001
License: Apache-2.0
"""
...
def csv_to_ppm(
    ...
    *,
    ...
    """Convert a CSV file to a PPM bitmap, one RGB-row per data row."""
