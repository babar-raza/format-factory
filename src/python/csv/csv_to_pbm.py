"""
csv_to_pbm.py — Dogfood export: CSV → PBM using Format Factory libraries.

Sprint: CSV-TO-PBM-DOGFOOD-001
Authority: TASK-007 -- Advance one dogfood export path
Ledger entry: R90-CSV-TO-PBM-DOGFOOD-001
License: Apache-2.0
"""
...
def csv_to_pbm(
    ...
    *,
    ...
    """Convert a CSV file to a PBM bitmap, one pixel-row per data row."""
