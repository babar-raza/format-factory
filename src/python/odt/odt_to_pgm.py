"""
odt_to_pgm.py — Dogfood export: ODT → PGM using Format Factory libraries.

Sprint: ODT-TO-PGM-DOGFOOD-001
Authority: TASK-007 -- Advance one dogfood export path
Ledger entry: R90-ODT-TO-PGM-DOGFOOD-001
License: Apache-2.0
"""
...
def odt_to_pgm(
    ...
    *,
    ...
    """Convert a ODT file to a PGM bitmap, one grayscale-row per data row."""
