"""
odt_to_ppm.py — Dogfood export: ODT → PPM using Format Factory libraries.

Sprint: ODT-TO-PPM-DOGFOOD-001
Authority: TASK-007 -- Advance one dogfood export path
Ledger entry: R90-ODT-TO-PPM-DOGFOOD-001
License: Apache-2.0
"""
...
def odt_to_ppm(
    ...
    *,
    ...
    """Convert a ODT file to a PPM bitmap, one RGB-row per data row."""
