"""
sylk_to_pgm.py — Dogfood export: SYLK → PGM using Format Factory libraries.

Sprint: SYLK-TO-PGM-DOGFOOD-001
Authority: TASK-007 -- Advance one dogfood export path
Ledger entry: R90-SYLK-TO-PGM-DOGFOOD-001
License: Apache-2.0
"""
...
def sylk_to_pgm(
    ...
    """Convert a SYLK file to a PGM bitmap, one grayscale-row per data row."""
