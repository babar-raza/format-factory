"""
toml_to_ppm.py — Dogfood export: TOML → PPM using Format Factory libraries.

Sprint: TOML-TO-PPM-DOGFOOD-001
Authority: TASK-007 -- Advance one dogfood export path
Ledger entry: R90-TOML-TO-PPM-DOGFOOD-001
License: Apache-2.0
"""
...
def toml_to_ppm(
    ...
    """Convert a TOML file to a PPM bitmap, one RGB-row per data row."""
