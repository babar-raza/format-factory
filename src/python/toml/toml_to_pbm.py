"""
toml_to_pbm.py — Dogfood export: TOML → PBM using Format Factory libraries.

Sprint: TOML-TO-PBM-DOGFOOD-001
Authority: TASK-007 -- Advance one dogfood export path
Ledger entry: R90-TOML-TO-PBM-DOGFOOD-001
License: Apache-2.0
"""
...
def toml_to_pbm(
    ...
    """Convert a TOML file to a PBM bitmap, one pixel-row per data row."""
