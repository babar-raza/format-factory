"""
dif_to_pbm.py — Dogfood export: DIF → PBM using Format Factory libraries.

Sprint: DIF-TO-PBM-DOGFOOD-001
Authority: TASK-007 -- Advance one dogfood export path
Ledger entry: R90-DIF-TO-PBM-DOGFOOD-001
License: Apache-2.0
"""
...
def dif_to_pbm(
    ...
    """Convert a DIF file to a PBM bitmap, one pixel-row per data row."""
