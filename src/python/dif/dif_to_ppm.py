"""
dif_to_ppm.py — Dogfood export: DIF → PPM using Format Factory libraries.

Sprint: DIF-TO-PPM-DOGFOOD-001
Authority: TASK-007 -- Advance one dogfood export path
Ledger entry: R90-DIF-TO-PPM-DOGFOOD-001
License: Apache-2.0
"""
...
def dif_to_ppm(
    ...
    """Convert a DIF file to a PPM bitmap, one RGB-row per data row."""
