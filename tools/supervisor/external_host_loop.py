# TOMBSTONE: external_host_loop.py quarantined 2026-07-06 -- SUSPECTED_GHOST (investigation)
...
raise DeprecationWarning(
    ...
    "If this fires, the file is LIVE via non-import path. Update register classification.")
