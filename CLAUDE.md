...
<!-- BEGIN:CAPABILITY-INDEX generated=2026-06-29T09:48:51+00:00 source=.governance/capabilities/registry.yaml -->
...
Total active capabilities: 99 | Canonical registry: `.governance/capabilities/registry.yaml`

| capability_id | status | product_track | parity_status | claude_code | codex |
|---|---|---|---|---|---|
| `backfill-task-skill-ownership` | active |  | FULL_PARITY | Y | Y |
| `build-capability-routes` | active |  | FULL_PARITY | Y | Y |
| `collect-skill-execution-receipts` | active |  | FULL_PARITY | Y | Y |
| `detect-ad-hoc-execution` | active |  | FULL_PARITY | Y | Y |
| `detect-duplicate-skills` | active |  | FULL_PARITY | Y | Y |
| `enforce-skill-first-execution` | active |  | FULL_PARITY | Y | Y |
| `inventory-commands` | active |  | FULL_PARITY | Y | Y |
| `inventory-skills` | active |  | FULL_PARITY | Y | Y |
| `normalize-skill-registry` | active |  | FULL_PARITY | Y | Y |
| `qname-backfill` | active |  | FULL_PARITY | Y | Y |
| `run-skill-idempotency` | active |  | FULL_PARITY | Y | Y |
| `scan-residual-bypasses` | active |  | FULL_PARITY | Y | Y |
| `sync-skill-command-registry` | active |  | FULL_PARITY | Y | Y |
| `validate-mutation-guard` | active |  | FULL_PARITY | Y | Y |
| `validate-skill-contracts` | active |  | FULL_PARITY | Y | Y |
