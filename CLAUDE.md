...
<!-- BEGIN:CAPABILITY-INDEX generated=2026-07-29T05:42:20+00:00 source=.governance/capabilities/registry.yaml -->
...
Total active capabilities: 195 | Canonical registry: `.governance/capabilities/registry.yaml`
...
| `audit-contract-portfolio` | active | format_contract | FULL_PARITY | Y | N |
| `backfill-format-contracts` | active | format_contract | FULL_PARITY | Y | N |
| `check-contract-sal-readiness` | active | format_contract | FULL_PARITY | Y | N |
| `compile-contract-gaps` | active | format_contract | FULL_PARITY | Y | N |
| `compile-format-contract` | active | format_contract | FULL_PARITY | Y | N |
| `compile-production-capability-universe` | active | format_contract | FULL_PARITY | Y | N |
| `create-format-family-pack` | active | format_contract | FULL_PARITY | Y | N |
| `format-contract-onboard` | active | format_contract | FULL_PARITY | Y | N |
| `investigate-format-contract` | active | format_contract | FULL_PARITY | Y | N |
| `product-contract-runtime-repair` | active | format_contract | FULL_PARITY | Y | N |
| `prove-format-contract` | active | format_contract | FULL_PARITY | Y | N |
| `reconcile-contract-capabilities` | active | format_contract | FULL_PARITY | Y | N |
| `refresh-format-contract` | active | format_contract | FULL_PARITY | Y | N |
| `research-format-contract-sources` | active | format_contract | FULL_PARITY | Y | N |
| `review-format-contract` | active | format_contract | FULL_PARITY | Y | N |
| `validate-format-contract` | active | format_contract | FULL_PARITY | Y | N |
...
| `agent-owasp-compliance` | active | governance | FULL_PARITY | Y | N |
| `agent-supply-chain` | active | governance | FULL_PARITY | Y | N |
| `audit-context-building` | active | governance | FULL_PARITY | Y | N |
...
| `certification-ci-gate` | active | governance | FULL_PARITY | Y | N |
| `certification-cross-language-parity` | active | governance | FULL_PARITY | Y | N |
...
| `certification-mutation-tester` | active | governance | FULL_PARITY | Y | N |
| `certification-performance-benchmark` | active | governance | FULL_PARITY | Y | N |
...
| `comment-analyzer` | active | governance | FULL_PARITY | Y | N |
| `create-ff-skill` | active | governance | FULL_PARITY | Y | N |
| `dependabot-config` | active | governance | FULL_PARITY | Y | N |
...
| `gha-security-review` | active | governance | FULL_PARITY | Y | N |
...
| `materialize-production-proof` | active | governance | FULL_PARITY | Y | N |
...
| `pr-test-analyzer` | active | governance | FULL_PARITY | Y | N |
| `pre-sprint-governance-hook` | active | governance | FULL_PARITY | Y | N |
| `preflight-skill-entry` | active | governance | FULL_PARITY | Y | N |
| `qname-backfill` | active | governance | FULL_PARITY | Y | N |
| `receiving-code-review` | active | governance | FULL_PARITY | Y | N |
...
| `sharp-edges` | active | governance | FULL_PARITY | Y | N |
| `silent-failure-hunter` | active | governance | FULL_PARITY | Y | N |
| `skill-improver` | active | governance | FULL_PARITY | Y | N |
| `skill-scanner` | active | governance | FULL_PARITY | Y | N |
| `skills-first-audit` | active | governance | FULL_PARITY | Y | N |
| `sync-skill-command-registry` | active | governance | FULL_PARITY | Y | N |
| `systematic-debugging` | active | governance | FULL_PARITY | Y | N |
| `test-driven-development` | active | governance | FULL_PARITY | Y | N |
| `trailmark` | active | governance | FULL_PARITY | Y | N |
| `type-design-analyzer` | active | governance | FULL_PARITY | Y | N |
...
| `capability-compiler` | active | infrastructure | FULL_PARITY | Y | N |
| `discover-existing-control-layers` | active | infrastructure | FULL_PARITY | Y | N |
| `gh-address-comments` | active | infrastructure | FULL_PARITY | Y | N |
| `gh-fix-ci` | active | infrastructure | FULL_PARITY | Y | N |
| `github-release` | active | infrastructure | FULL_PARITY | Y | N |
| `inventory-existing-control-features` | active | infrastructure | FULL_PARITY | Y | N |
| `plan-control` | active | infrastructure | FULL_PARITY | Y | N |
...
| `mcp-builder` | active | machinery_governance | FULL_PARITY | Y | N |
| `worktree-skill-guard-repair` | active | machinery_governance | FULL_PARITY | Y | N |
| `production-program-controller-repair` | active | machinery_repair | FULL_PARITY | Y | N |
| `reconcile-stashed-work` | active | machinery_repair | FULL_PARITY | Y | Y |
...
| `refresh-provider-neutral-handover` | active | planning | FULL_PARITY | Y | N |
...
| `fix-exception-hierarchy` | active | src_healing | FULL_PARITY | Y | N |
| `wire-analytics-module` | active | src_healing | FULL_PARITY | Y | N |
| `add-roundtrip-test` | active | testing | FULL_PARITY | Y | N |
| `property-based-testing` | active | testing | FULL_PARITY | Y | N |
