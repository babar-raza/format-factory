...
<!-- BEGIN:CAPABILITY-INDEX generated=2026-07-06T11:51:37+00:00 source=.governance/capabilities/registry.yaml -->
...
Total active capabilities: 120 | Canonical registry: `.governance/capabilities/registry.yaml`

| capability_id | status | product_track | parity_status | claude_code | codex |
|---|---|---|---|---|---|
| `backfill-gate4-prototype-evidence` | active | acquisition | FULL_PARITY | Y | Y |
...
| `build-obligation-register` | active | all_format_deepening | FULL_PARITY | Y | Y |
| `portfolio-reconcile` | active | all_format_deepening | FULL_PARITY | Y | Y |
| `update-obligation-entry` | active | all_format_deepening | FULL_PARITY | Y | Y |
| `verify-obligation-entry` | active | all_format_deepening | FULL_PARITY | Y | Y |
...
| `add-spec-analytics-function` | active | foss_python | FULL_PARITY | Y | Y |
| `format-feature-expansion` | active | foss_python | FULL_PARITY | Y | Y |
| `new-format-kickstart` | active | foss_python | FULL_PARITY | Y | Y |
| `product-source-task` | active | foss_python | FULL_PARITY | Y | Y |
| `python-reduced-spec-parity-model` | active | foss_python | FULL_PARITY | Y | Y |
| `create-consumer-roundtrip` | active | foss_python_consumer | FULL_PARITY | Y | Y |
| `backfill-task-skill-ownership` | active | governance | FULL_PARITY | Y | Y |
| `build-capability-routes` | active | governance | FULL_PARITY | Y | Y |
| `certification-assertion-scorer` | active | governance | FULL_PARITY | Y | Y |
| `certification-dashboard` | active | governance | FULL_PARITY | Y | Y |
| `certification-dotnet-assertion-scorer` | active | governance | FULL_PARITY | Y | Y |
| `certification-exception-checker` | active | governance | FULL_PARITY | Y | Y |
| `certification-fix-weak-assertions` | active | governance | FULL_PARITY | Y | Y |
| `certification-generate-exception-tests` | active | governance | FULL_PARITY | Y | Y |
| `certification-generate-security-tests` | active | governance | FULL_PARITY | Y | Y |
| `certification-inventory-extractor` | active | governance | FULL_PARITY | Y | Y |
| `certification-stub-detector` | active | governance | FULL_PARITY | Y | Y |
...
| `query-control-index` | active | infrastructure | FULL_PARITY | Y | Y |
| `append-layer-verification-log` | active | layer_governance | FULL_PARITY | Y | Y |
| `append-layer-work-log` | active | layer_governance | FULL_PARITY | Y | Y |
| `capability-status` | active | layer_governance | FULL_PARITY | Y | Y |
| `close-layer-task` | active | layer_governance | FULL_PARITY | Y | Y |
| `create-cross-layer-handoff` | active | layer_governance | FULL_PARITY | Y | Y |
| `create-permanent-layer-plan` | active | layer_governance | FULL_PARITY | Y | Y |
| `detect-stale-layer-state` | active | layer_governance | FULL_PARITY | Y | Y |
| `detect-unlogged-work` | active | layer_governance | FULL_PARITY | Y | Y |
| `documentation-structure-migration` | active | layer_governance | FULL_PARITY | Y | Y |
| `generate-root-status` | active | layer_governance | FULL_PARITY | Y | Y |
| `identify-primary-layer` | active | layer_governance | FULL_PARITY | Y | Y |
| `inventory-permanent-layer-plans` | active | layer_governance | FULL_PARITY | Y | Y |
| `migrate-temporary-agent-plan` | active | layer_governance | FULL_PARITY | Y | Y |
| `reconcile-layer-index` | active | layer_governance | FULL_PARITY | Y | Y |
| `reconcile-layer-task-register` | active | layer_governance | FULL_PARITY | Y | Y |
| `register-layer-gap` | active | layer_governance | FULL_PARITY | Y | Y |
| `register-layer-task` | active | layer_governance | FULL_PARITY | Y | Y |
| `select-next-layer-task` | active | layer_governance | FULL_PARITY | Y | Y |
| `sync-capabilities` | active | layer_governance | FULL_PARITY | Y | Y |
| `sync-readmes` | active | layer_governance | FULL_PARITY | Y | Y |
| `update-layer-current-state` | active | layer_governance | FULL_PARITY | Y | Y |
| `update-layer-master-index` | active | layer_governance | FULL_PARITY | Y | Y |
| `update-layer-session-handoff` | active | layer_governance | FULL_PARITY | Y | Y |
| `validate-capability-parity` | active | layer_governance | FULL_PARITY | Y | Y |
| `validate-permanent-layer-plans` | active | layer_governance | FULL_PARITY | Y | Y |
| `audit-root-tools` | active | machinery_governance | FULL_PARITY | Y | Y |
| `found-issue-ownership` | active | machinery_governance | PARTIAL | Y | Y |
| `rollback-and-recovery` | active | machinery_repair | FULL_PARITY | Y | Y |
| `sync-memory` | active | maintenance | FULL_PARITY | Y | Y |
| `run-oracle` | active | oracle_execution | FULL_PARITY | Y | Y |
| `package-install-proof` | active | packaging | FULL_PARITY | Y | Y |
| `sync-installed-packages` | active | packaging | FULL_PARITY | Y | Y |
...
| `diff-playbook-outputs` | active | playbook_governance | FULL_PARITY | Y | Y |
| `export-review-queue` | active | playbook_governance | FULL_PARITY | Y | Y |
| `replay-acquisition-playbook` | active | playbook_governance | FULL_PARITY | Y | Y |
| `validate-playbook` | active | playbook_governance | FULL_PARITY | Y | Y |
| `sal-pipeline-heal` | active | sal_infrastructure | FULL_PARITY | Y | Y |
| `ingest-spec-sal` | active | sal_ingestion | FULL_PARITY | Y | Y |
| `update-capability-matrix` | active | shared_reference_snapshot | FULL_PARITY | Y | Y |
| `check-source-loc` | active | source_structure | FULL_PARITY | Y | Y |
