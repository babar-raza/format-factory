...
UblDocument, and reports a load-time failure as a non-raising FATAL
...
from format_factory.ubl import load, validate
...
def test_a_valid_source_produces_the_same_report_whether_given_as_a_path_or_a_preloaded_document() -> (
    ...
    path = SAMPLES / "valid" / "minimal-invoice.xml"
    document = load(path)
