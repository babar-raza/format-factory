...
# Pin stdlib csv in sys.modules so src/python/csv never shadows it.
# The Format Factory csv package (src/python/csv/__init__.py) is a thin wrapper
...
# The FF csv package remains importable as 'src.python.csv' or via direct path
