...
class TestRegistryStability(unittest.TestCase):
    ...
    def test_total_skill_count(self):
        # Registry expanded from 32 skills (R98 baseline) to 123 skills (R107+ governance expansion)
        self.assertEqual(len(self.skills), 123, f"Expected 123 total, got {len(self.skills)}")
