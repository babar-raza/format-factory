"""Tests for tsv_to_fodg dogfood export."""
...
class TestTSVToFodgPaths:
    ...
    def test_accepts_string_paths(self, tmp_path):
        dest = tmp_path / "out.fodg"
        count = tsv_to_fodg(str(SAMPLE), str(dest))
