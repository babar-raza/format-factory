"""Tests for CsvDocument mutation API: add_row(), set_cell(), save_to_file().

Sprint: CSV-PYTHON-MUTATION-001
"""
import sys
import tempfile
...
class TestAddRow:
    def test_add_row_appends(self):
        doc = CsvDocument.from_file(SAMPLE_CSV)
