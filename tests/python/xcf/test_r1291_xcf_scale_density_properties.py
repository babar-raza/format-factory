"""Tests for R1291: XcfDocument canvas scale and density classification properties.
...
class TestPixelDensityClass:
    ...
    def test_boundary_65x64_is_small(self):
        # 65*64 = 4160 > 4096 → small
        doc = _make_doc(65, 64)
        assert doc.pixel_density_class == "small"
...
class TestCrossPropertyConsistency:
    ...
    def test_multi_layer_banner(self):
        doc = _make_doc(400, 100, layers=5)
        assert doc.is_banner is True
        assert doc.layer_count == 5
