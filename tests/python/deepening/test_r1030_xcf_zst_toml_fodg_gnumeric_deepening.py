"""Sprint 477 - XCF deepening: 2 compound analytics functions, 10 tests."""
...
class TestXcfFileSizeTimes153PlusImageTypeTimes10400PlusWidthTimesHeightTimes5500:
    def test_returns_int(self):
        result = xcf_file_size_times_153_plus_image_type_times_10400_plus_width_times_height_times_5500(_SAMPLE)
        assert isinstance(result, int)
    ...
    def test_accepts_str_path(self):
        result = xcf_file_size_times_153_plus_image_type_times_10400_plus_width_times_height_times_5500(str(_SAMPLE))
        assert result == FN2_EXPECTED
