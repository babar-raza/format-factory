"""Sprint 407 — ZST deepening: 2 compound analytics functions, 10 tests."""
...
class TestZstCompressedTimes89PlusDecompressedMod600Times490PlusFileSizeTimes120:
    def test_returns_int(self):
        result = zst_compressed_times_89_plus_decompressed_mod_600_times_490_plus_file_size_times_120(_SAMPLE)
        assert isinstance(result, int)
    ...
    def test_accepts_str_path(self):
        result = zst_compressed_times_89_plus_decompressed_mod_600_times_490_plus_file_size_times_120(str(_SAMPLE))
        assert result == FN2_EXPECTED
