...
VENDORED = (
    ...
    / "src/python/ipynb/src/format_factory/ipynb/validation/schemas"
)
...
def test_every_minor_schema_loads(minor: int) -> None:
    from format_factory.ipynb.validation.schema import _schema
...
def test_minimal_notebook_validates_against_the_official_schema() -> None:
    from format_factory.ipynb.validation.validator import validate
...
def test_missing_schema_resource_still_raises() -> None:
    from format_factory.ipynb.validation.schema import _resource_name
