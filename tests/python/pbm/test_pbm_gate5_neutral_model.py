"""Gate 5 neutral model tests for PBM parser."""

import sys
import os

sys.path.insert(0, os.path.join(os.path.dirname(__file__), "..", "..", "..", "src", "python"))
from pbm.pbm_parser import SUPPORTED_FEATURES, UNSUPPORTED_FEATURES, get_capabilities


class TestPbmGate5NeutralModel:
    ...
    def test_key_supported_features(self):
        ...
        assert "bitmap_pixel_decode" in SUPPORTED_FEATURES
