...
test_obligation_security_baseline.py's own comprehensive NRRD-SEC-001 sweep
...
is the builtin eval/exec/compile call surface, which import-based scanning
cannot see. Added here rather than editing that file, to avoid disturbing
an existing, passing NRRD-SEC-001 obligation proof.
"""
