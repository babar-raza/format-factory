...
3. **Security baseline required.** The prototype README must document which threat categories from `docs/security.md` apply and what mitigations are in place. A prototype that does not address XXE or entity expansion for XML formats does not pass Gate 4.
...
- Security mitigations applied (mapped to `docs/security.md` threat categories)
