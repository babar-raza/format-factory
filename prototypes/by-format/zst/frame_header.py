"""
ZST Frame Header Reader — Gate 4 Prototype
...
This module reads the first few bytes of a ZST frame to extract header metadata
without performing full decompression. It covers:
