...
| Hybrid Spec Retrieval | docs/ai/spec-retrieval-strategy.md (run027); AGENTS.md Section X; GOVERNANCE.md Section 17 |
...
| Final HEAD authority | bundle-metadata/git-log.txt (see docs/governance/current-state-and-evidence-authority.md). last_completed_run: run050 |
...
| run027 | Independent verification + stale state + Hybrid Spec Retrieval | 21 checks PASS; SHA-256 hashes computed; Gate 3 → sample_corpus_verified_pending_human_review; docs/ai/spec-retrieval-strategy.md; TC-0015/0016; AGENTS.md X; committed 09ee31f; master-plan v2.23 |
