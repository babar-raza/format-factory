...
| `23-ai-usage-operating-model-20260513.md` | AI-USAGE-LOCAL-DOC-SYNC-20260513: Human authorized AI acceleration. AI is accelerator not authority. docs/ai/ai-usage-operating-model.md, docs/ai/ai-assisted-commercial-development.md, docs/ai/spec-retrieval-and-rag-policy.md, docs/ai/agent-swarm-ai-orchestration.md created. AGENTS.md AF12 + GOVERNANCE.md 26.10 added. 5 AI taskcards created. |
...
| `25-assistant-supervision-methodology-20260513.md` | CHATGPT-MEMORY-LOCAL-SYNC-20260513-ADDENDUM: Captures the supervision and execution methodology expected by Babar Raza. Evidence-first review, challenge-agent-claims, ready-to-send prompts, controlled swarm execution, AI governance, generated-requirements-first, gate/evidence safety, new-chat behavior checklist, next-agent behavior checklist. Full methodology in docs/automation/assistant-supervision-methodology.md. |
| `26-format-expansion-roadmap-and-non-aspose-backlog-20260514.md` | FORMAT-FACTORY-ROADMAP-MEMORY-SYNC-001 (2026-05-14): Strategic format expansion direction, immediate/short-term/long-term roadmap, and full non-Aspose candidate backlog (13 categories, ~200+ candidates, all marked needs_audit). Immediate: finish XML proof (FODS/FODT) + Conway R1-R9. Short-term: expand to public-spec XML/package formats. Long-term: any format family with sufficient public technical info. Key files: docs/python-foss/format-expansion-roadmap.md/.yaml, taskcards/FORMAT-EXPANSION-ROADMAP.md, NON-ASPOSE-FORMAT-BACKLOG.md, PUBLIC-SPEC-FORMAT-EXPANSION.md. |
| `27-r85-product-factory-direction.md` | FORMAT-FACTORY-R85-PRODUCT-FACTORY-DIRECTION-RESET (2026-05-31): CRITICAL direction correction — evidence is support infrastructure, not the product. POC targets: 3 commercial .NET (FODS/FODT/Netpbm) + 3 reduced FOSS (ZST/Netpbm-Python/SYLK). Product success = load+edit+save+export+dogfood from installed package. Local supervisor loop replaces manual ChatGPT handoff. Dogfooding requirement added. No-drift anchors. See product-capability-matrix/poc-targets.yaml, docs/export/dogfood-export-strategy.md. Required reading for all R85+ sprint work. |
| `65-r90-product-factory-acceleration-20260602.md` | R90 governed Product Factory Acceleration Layer, R89 audit, and Python Netpbm PPM-to-PGM dogfood export. |
...
| `48-r28-gate5-gate7-xcf-candidates-20260519.md` | FORMAT-FACTORY-R28-GATE5-GATE7-ORACLE-FUZZ-XCF-ZPAQ-G11-C9-PUBLICATION-HARDENING-001 (2026-05-19). R28 non-AI sprint. ODS/ODT/QOI Gate 5 neutral model (52 tests). Gate 6 oracle (19 tests). Gate 7 fuzz guards (23 tests). XCF Gate 4 prototype (17 tests). ZPAQ G3 BLOCKED. FODS C9 157/157, FODT C9 145/145. DIF Gates 1-3 PASS (8.7/10), PPM Gates 1-3 PASS (9.1/10). |
| `49-r28-ai-platform-hardening-e2e-requirements-20260519.md` | FORMAT-FACTORY-R28-FULL-THROTTLE-AI-FORMAT-COMMERCIAL-PUBLICATION-AND-EVIDENCE-TRAIN-001 (2026-05-19). R28 AI lanes. 6 new AI modules (citation_verifier, contradiction_detector, evaluator, e2e_pilot, requirements/generator, pipeline __init__). 4 new test files (+60 AI tests, +7 evidence tests). R27 closure repair. 7 AI taskcard state corrections. E2E pilot fixture mode. Requirements pipeline with provenance. Evidence automation hardening. |
| `50-r29-mega-train-state-consistency-ai-format-commercial-publication-evidence-20260519.md` | FORMAT-FACTORY-R29-MEGA-TRAIN-STATE-CONSISTENCY-AI-FORMAT-COMMERCIAL-PUBLICATION-EVIDENCE-001 (2026-05-19). R28 sprint-state defect repaired. Evidence validator semantic hardening (6 tests). AI synthesis/evaluator productionization (31 tests). AI retrieval/telemetry hardening (17 tests). AI: 310/310. Evidence: 135/135. Python: 645/4skip. .NET FODS 157, FODT 145. Mega-train operating rule mandated. |
| `51-r30-ai-defect-closure-evidence-identity-format-productization-20260519.md` | FORMAT-FACTORY-R30 (2026-05-19). 10 AI defects closed. PGM/PBM/SYLK Gate 3->7 (+120 tests). AI: 358/358. Python: 774/4skip. 48 new AI defect closure tests. |
| `52-r32-ai-clean-closure-and-pipeline-deepening-20260519.md` | FORMAT-FACTORY-R32 (2026-05-19). R31 metadata repair. Lexical retriever. Live citation pipeline. litellm lazy import. 506 AI tests. 57 new tests. Verification matrix doc. |
| `57-r49-object-model-edit-save-export-ai-acceleration-20260522.md` | FORMAT-FACTORY-R49 (2026-05-22). FODS+FODT Python object-model POC (13+12 tests). FODT writer fix (blocks/headings). .NET POC PASS. Preservation matrices. ZST RC. Phase Audit 3 expansion. 33 new tests. |
| `58-r53-self-verifying-baseline-20260522.md` | FORMAT-FACTORY-R53-SELF-VERIFYING-BASELINE-001 (2026-05-22). TC-0054 FODS formula preservation CLOSED. Sidecar proof protocol adopted. Requirements-vs-actual matrix (22 reqs). Gap ledger (10 gaps). AI gateway audit PASS. Verdict: R53_STATE_VALIDATOR_CLEAN_PRODUCT_PARTIAL. Pass 1 SHA: 3d1ca09b... Pass 2 SHA: 8e99b1ec... |
| `59-r54-sidecar-enforcement-fodt-preservation-20260523.md` | FORMAT-FACTORY-R54-SIDECAR-ENFORCEMENT-FODT-PRESERVATION-PHASE5-MEGA-TRAIN-001 (2026-05-23). Fail-closed sidecar enforcement (check_sidecar_required, --verify flag). Artifact policy (none/external_ref/self_contained). TC mislabeling repaired. TC-0054 closed. FODT list+table preservation (_write_list, _write_table). INV-006..010 added. 72 new tests. Verdict: R54_STATE_SIDECAR_ENFORCEMENT_FODT_PRESERVATION_PARTIAL. |
...
| Format expansion and non-Aspose backlog | memory/26-format-expansion-roadmap-and-non-aspose-backlog-20260514.md, docs/python-foss/format-expansion-roadmap.md, taskcards/FORMAT-EXPANSION-ROADMAP.md, taskcards/NON-ASPOSE-FORMAT-BACKLOG.md |
...
| memory-sprint-2026-05-08 | Memory sprint | 00-index.md, 11-format-understanding-and-llm-strategy.md (NEW), AGENTS.md Sections AB+AC, GOVERNANCE.md Sections 21+22, docs/python-foss/format-understanding-layer.md (NEW), docs/ai/llm-and-embedding-strategy.md (NEW), docs/python-foss/format-representation-model.md (NEW), docs/python-foss/non-aspose-format-candidate-registry-plan.md (NEW), plans/master-plan.md Section 37 (NEW), ROADMAP.md Architecture Backlog (NEW), taskcards/FUL-001--FUL-004 (NEW), taskcards/LLM-001 (NEW), taskcards/EMB-001 (NEW), taskcards/REP-001 (NEW), taskcards/REP-003 (NEW), taskcards/NAC-001 (NEW), taskcards/GOV-001 (NEW) |
...
| CHATGPT-MEMORY-LOCAL-SYNC-20260513 | ChatGPT session too long; full project continuity synced to local repo | 24-chatgpt-session-memory-sync-20260513.md (NEW), 00-index.md (UPDATED), docs/automation/fresh-chat-project-bootstrap.md (NEW), docs/automation/fresh-chat-project-bootstrap.yaml (NEW), reports/governance/chatgpt-memory-local-sync-20260513.md (NEW), reports/planning/current-project-continuity-map-20260513.md (NEW), 3 taskcards (NEW), evidence contract + bundle. No Gate 11 approval, no .NET FOSS, no product source, no push. |
| CHATGPT-MEMORY-LOCAL-SYNC-20260513-ADDENDUM | Supervision methodology and execution standards transferred to local repo | 25-assistant-supervision-methodology-20260513.md (NEW), docs/automation/assistant-supervision-methodology.md (NEW), docs/automation/assistant-supervision-methodology.yaml (NEW), docs/governance/project-execution-standards.md (NEW), docs/governance/project-execution-standards.yaml (NEW), docs/automation/fresh-chat-project-bootstrap.md (UPDATED — working style section), docs/automation/fresh-chat-project-bootstrap.yaml (UPDATED — working style fields), 00-index.md (UPDATED), AGENTS.md (UPDATED — AF15), GOVERNANCE.md (UPDATED — 26.13), 2 taskcards (NEW), governance sync reports (NEW). |
| FORMAT-FACTORY-ROADMAP-MEMORY-SYNC-001 | Strategic format expansion roadmap and non-Aspose candidate backlog synced to local repo | 26-format-expansion-roadmap-and-non-aspose-backlog-20260514.md (NEW), docs/python-foss/format-expansion-roadmap.md (NEW), docs/python-foss/format-expansion-roadmap.yaml (NEW), docs/automation/fresh-chat-project-bootstrap.md (UPDATED — format roadmap section), docs/automation/fresh-chat-project-bootstrap.yaml (UPDATED — format roadmap fields), plans/master-plan.md (UPDATED — Section 38), taskcards/FORMAT-EXPANSION-ROADMAP.md (NEW), taskcards/NON-ASPOSE-FORMAT-BACKLOG.md (NEW), taskcards/PUBLIC-SPEC-FORMAT-EXPANSION.md (NEW), reports/planning/format-expansion-roadmap-memory-sync-20260514.md (NEW), tools/evidence/contracts/format-expansion-roadmap-memory-sync-20260514.yaml (NEW), 00-index.md (UPDATED). No Gate 11 approval, no format acquisition, no product source, no push. |
...
| FORMAT-FACTORY-R53-SELF-VERIFYING-BASELINE-001 | R53 sprint memory integration | 58-r53-self-verifying-baseline-20260522.md (NEW), 00-index.md (UPDATED), MEMORY.md (UPDATED). TC-0054 closed. Sidecar proof protocol. Requirements matrix. INV-001..005. AI audit PASS. |
| FORMAT-FACTORY-R54-SIDECAR-ENFORCEMENT-FODT-PRESERVATION-PHASE5-MEGA-TRAIN-001 | R54 sprint memory integration | 59-r54-sidecar-enforcement-fodt-preservation-20260523.md (NEW), 00-index.md (UPDATED), MEMORY.md (UPDATED). Fail-closed sidecar. Artifact policy. TC mislabeling repaired. FODT list+table writer. INV-006..010. 72 new tests. |
