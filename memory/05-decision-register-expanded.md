...
| D-048 | Hybrid Spec Retrieval Strategy: 3-tier hierarchy (deterministic → lexical → vector/future) | Decided (run027) | `docs/ai/spec-retrieval-strategy.md` defines the policy. AGENTS.md Section X added. Tier 3 future: TC-0015/TC-0016. |
